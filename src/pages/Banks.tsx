    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main className="flex-1 max-w-[1200px] mx-auto px-4 py-8 w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-card p-4 rounded-xl border border-primary/10 text-center">
            <div className="text-3xl font-black text-primary">{banks.length}</div>
          ...
          <div className="bg-card p-4 rounded-xl border border-primary/10 text-center">
            ...
            <div className="text-sm text-muted-foreground">FDR Options</div>
          </div>
        </div>
        ...
        {filteredBanks.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-lg text-muted-foreground">No banks found matching "{searchQuery}"</p>
          </div>
        )}
      </main>
      <Footer />
