...
class EblScraper(BaseScraper):
    """Scraper for Eastern Bank Limited credit cards and loan products."""
    
    BASE_URL = "https://www.ebl.com.bd"
    CARDS_URL = "https://www.ebl.com.bd/consumer-banking/cards/credit-cards"
    
    def get_bank_slug(self) -> str:
        return "eastern-bank"
    
    def scrape_credit_cards(self) -> list[dict]:
        """Scrape credit card data from EBL website."""
        cards = []
        ...
        try:
            ...
            self.logger.error(f"Error scraping EBL cards: {e}")
            cards = self._get_fallback_cards()
    ...
    def _get_fallback_cards(self) -> list[dict]:
        ...
        return [
            {
                "name": "EBL Visa Platinum Credit Card",
                "annual_fee": "BDT 5,000",
                "interest_rate": "20% p.a.",
                "features": ["EBL Skybanking", "Airport Lounge Access"],
                "detail_url": f"{self.BASE_URL}/consumer-banking/cards/credit-cards",
                "is_fallback": True
            },
            {
                "name": "EBL Visa Signature Credit Card",
                "annual_fee": "BDT 10,000",
                "interest_rate": "20% p.a.",
                "features": ["Meet & Greet Service", "Global Data Roaming"],
                "detail_url": f"{self.BASE_URL}/consumer-banking/cards/credit-cards",
                "is_fallback": True
            }
        ]
